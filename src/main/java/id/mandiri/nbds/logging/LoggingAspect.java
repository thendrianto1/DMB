package id.mandiri.nbds.logging;
...
public class LoggingAspect {
	...
	@AfterReturning(pointcut = "execution(* id.mandiri.nbds..*.*(..))", returning = "retVal")
